...
{
    [DbContext(typeof(DB))]
    [Migration("20191115123656_FAQSvarAdded")]
    partial class FAQSvarAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TogbilletterOblig3.Models.SporsmalOgSvar", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TogbilletterOblig3.Models.SporsmalOgSvar", b =>
                {
                    b.HasOne("TogbilletterOblig3.Models.Sporsmal", "sp")
                        .WithMany()
                        .HasForeignKey("spID");

                    b.HasOne("TogbilletterOblig3.Models.Svar", "svar")
                        .WithMany()
